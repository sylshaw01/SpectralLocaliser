...
cat > job1dSSHkappatopological.sh << "EOF"
#!/bin/bash
...
python 1dSSHkappatopological_combined.py $p "$1"
EOF
...
with open("1dSSHkappatopological_combined.py", "w") as f:
    f.write(combined)
EOF

sbatch job1dSSHkappatopological.sh $1
