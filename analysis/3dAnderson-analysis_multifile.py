...
daterange_start_str = '2025-10-11-01-00-00'
daterange_end_str = '2025-10-25-23-59-59'
...
file_pattern = os.path.join(datalocation, '3dAnderson_L*_rho60.0_kappa0.1_disorder*_results.npz')
